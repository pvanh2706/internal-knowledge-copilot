...
public sealed class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TeamEntity>(entity =>
        {
            ...
            entity.Property(team => team.TenantId).HasColumnName("tenant_id");
            ...
            entity.HasIndex(team => team.TenantId);
            entity.HasIndex(team => new { team.TenantId, team.Name }).IsUnique();
        });
        ...
        modelBuilder.Entity<FolderEntity>(entity =>
        {
            ...
            entity.Property(folder => folder.TenantId).HasColumnName("tenant_id");
            ...
            entity.HasIndex(folder => folder.TenantId);
        ...
        modelBuilder.Entity<FolderPermissionEntity>(entity =>
        {
            ...
            entity.Property(permission => permission.TenantId).HasColumnName("tenant_id");
            ...
            entity.HasIndex(permission => permission.TenantId);
            entity.HasIndex(permission => new { permission.TenantId, permission.FolderId, permission.TeamId }).IsUnique();
        ...
        modelBuilder.Entity<UserFolderPermissionEntity>(entity =>
        {
            ...
            entity.Property(permission => permission.UpdatedAt).HasColumnName("updated_at");
            entity.HasIndex(permission => permission.TenantId);
            entity.HasIndex(permission => new { permission.TenantId, permission.UserId, permission.FolderId }).IsUnique();
        ...
        modelBuilder.Entity<DocumentVersionEntity>(entity =>
        {
            ...
            entity.HasIndex(version => version.TenantId);
        ...
        modelBuilder.Entity<AiInteractionEntity>(entity =>
        {
            ...
            entity.Property(interaction => interaction.TenantId).HasColumnName("tenant_id");
        ...
        modelBuilder.Entity<AiInteractionSourceEntity>(entity =>
        {
            ...
            entity.Property(source => source.ApplicationId).HasColumnName("application_id");
            entity.Property(source => source.KnowledgeSourceId).HasColumnName("knowledge_source_id");
            ...
            entity.Property(source => source.ExternalObjectRecordId).HasColumnName("external_object_record_id");
            entity.Property(source => source.ExternalObjectType).HasColumnName("external_object_type").HasMaxLength(100);
            entity.Property(source => source.ExternalObjectId).HasColumnName("external_object_id").HasMaxLength(300);
            ...
            entity.Property(source => source.CreatedAt).HasColumnName("created_at");
            entity.HasIndex(source => source.TenantId);
            entity.HasIndex(source => new { source.TenantId, source.AiInteractionId });
            entity.HasIndex(source => new { source.TenantId, source.ApplicationId });
            entity.HasIndex(source => new { source.TenantId, source.KnowledgeSourceId });
            entity.HasIndex(source => new { source.TenantId, source.ApplicationId, source.ExternalObjectType, source.ExternalObjectId });
        ...
        modelBuilder.Entity<AiFeedbackEntity>(entity =>
        {
            ...
            entity.Property(feedback => feedback.TenantId).HasColumnName("tenant_id");
            ...
            entity.HasIndex(feedback => feedback.TenantId);
            entity.HasIndex(feedback => new { feedback.TenantId, feedback.AiInteractionId, feedback.UserId }).IsUnique();
            entity.HasIndex(feedback => new { feedback.TenantId, feedback.Value, feedback.ReviewStatus });
        ...
        modelBuilder.Entity<AiQualityIssueEntity>(entity =>
        {
            ...
            entity.Property(issue => issue.TenantId).HasColumnName("tenant_id");
            ...
            entity.HasIndex(issue => issue.TenantId);
            entity.HasIndex(issue => new { issue.TenantId, issue.AiFeedbackId }).IsUnique();
            entity.HasIndex(issue => new { issue.TenantId, issue.Status, issue.CreatedAt });
        ...
        modelBuilder.Entity<KnowledgeCorrectionEntity>(entity =>
        {
            ...
            entity.Property(correction => correction.TenantId).HasColumnName("tenant_id");
            ...
            entity.HasIndex(correction => correction.TenantId);
            entity.HasIndex(correction => new { correction.TenantId, correction.QualityIssueId });
            entity.HasIndex(correction => new { correction.TenantId, correction.Status, correction.CreatedAt });
        ...
        modelBuilder.Entity<RetrievalHintEntity>(entity =>
        {
            ...
            entity.Property(hint => hint.TenantId).HasColumnName("tenant_id");
            ...
            entity.HasIndex(hint => hint.TenantId);
            entity.HasIndex(hint => new { hint.TenantId, hint.CorrectionId });
        ...
        modelBuilder.Entity<KnowledgeChunkEntity>(entity =>
        {
            ...
            entity.Property(chunk => chunk.TenantId).HasColumnName("tenant_id");
            entity.Property(chunk => chunk.ApplicationId).HasColumnName("application_id");
            entity.Property(chunk => chunk.KnowledgeSourceId).HasColumnName("knowledge_source_id");
            ...
            entity.Property(chunk => chunk.CorrectionId).HasColumnName("correction_id");
            entity.Property(chunk => chunk.ExternalObjectRecordId).HasColumnName("external_object_record_id");
            entity.Property(chunk => chunk.ExternalObjectType).HasColumnName("external_object_type").HasMaxLength(100);
            entity.Property(chunk => chunk.ExternalObjectId).HasColumnName("external_object_id").HasMaxLength(300);
            ...
            entity.Property(chunk => chunk.TextHash).HasColumnName("text_hash").HasMaxLength(200).IsRequired();
            entity.Property(chunk => chunk.VectorId).HasColumnName("vector_id").HasMaxLength(200).IsRequired();
            entity.Property(chunk => chunk.MetadataJson).HasColumnName("metadata_json").IsRequired();
            ...
            entity.HasIndex(chunk => chunk.TenantId);
            entity.HasIndex(chunk => new { chunk.TenantId, chunk.ApplicationId });
            entity.HasIndex(chunk => new { chunk.TenantId, chunk.KnowledgeSourceId });
            entity.HasIndex(chunk => new { chunk.TenantId, chunk.SourceType, chunk.SourceId });
            entity.HasIndex(chunk => new { chunk.TenantId, chunk.SourceType, chunk.Status });
            entity.HasIndex(chunk => new { chunk.TenantId, chunk.ApplicationId, chunk.KnowledgeSourceId });
            entity.HasIndex(chunk => new { chunk.TenantId, chunk.ApplicationId, chunk.ExternalObjectType, chunk.ExternalObjectId });
            entity.HasIndex(chunk => chunk.FolderId);
            entity.HasIndex(chunk => chunk.DocumentId);
            entity.HasIndex(chunk => chunk.DocumentVersionId);
            entity.HasIndex(chunk => chunk.TextHash);
        });
        ...
        modelBuilder.Entity<EvaluationCaseEntity>(entity =>
        {
            ...
            entity.Property(evaluationCase => evaluationCase.TenantId).HasColumnName("tenant_id");
        ...
        modelBuilder.Entity<EvaluationRunEntity>(entity =>
        {
            ...
            entity.Property(run => run.TenantId).HasColumnName("tenant_id");
            ...
            entity.HasIndex(run => run.TenantId);
        ...
        modelBuilder.Entity<EvaluationRunResultEntity>(entity =>
        {
            ...
            entity.Property(result => result.TenantId).HasColumnName("tenant_id");
            ...
            entity.HasIndex(result => result.TenantId);
            entity.HasIndex(result => new { result.TenantId, result.EvaluationRunId });
            entity.HasIndex(result => new { result.TenantId, result.EvaluationCaseId, result.CreatedAt });
        ...
        modelBuilder.Entity<WikiDraftEntity>(entity =>
        {
            ...
            entity.Property(draft => draft.TenantId).HasColumnName("tenant_id");
            ...
            entity.HasIndex(draft => draft.TenantId);
            entity.HasIndex(draft => new { draft.TenantId, draft.Status });
            entity.HasIndex(draft => new { draft.TenantId, draft.SourceDocumentId });
        ...
        modelBuilder.Entity<WikiPageEntity>(entity =>
        {
            ...
            entity.Property(page => page.TenantId).HasColumnName("tenant_id");
        ...
        modelBuilder.Entity<AuditLogEntity>(entity =>
        {
            ...
            entity.Property(log => log.TenantId).HasColumnName("tenant_id");
            ...
            entity.HasIndex(log => new { log.TenantId, log.Action });
            entity.HasIndex(log => new { log.TenantId, log.EntityType });
        ...
        modelBuilder.Entity<AiProviderSettingEntity>(entity =>
        {
            ...
            entity.Property(setting => setting.TenantId).HasColumnName("tenant_id");
