...
{
    /// <inheritdoc />
    public partial class AddKeywordChunkIndex : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "knowledge_chunk_indexes",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_knowledge_chunk_indexes", x => x.chunk_id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_knowledge_chunk_indexes_document_id",
                table: "knowledge_chunk_indexes",
                column: "document_id");

            migrationBuilder.CreateIndex(
                name: "IX_knowledge_chunk_indexes_folder_id",
                table: "knowledge_chunk_indexes",
                column: "folder_id");
